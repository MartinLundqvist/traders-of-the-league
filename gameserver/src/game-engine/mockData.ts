...
export const MOCK_GAME: IGame = {
  ...
  achievements: [
    ...
    { name: 'Merchant A', description: 'Five contracts worth 1 VP', value: 5 },
    {
    ...
    { name: 'Specialist A', description: 'Four blue contracts', value: 3 },
  ],
  ...
  players: [
    {
      ...
      achievementsProgress: [
        ...
        { achievementName: 'Regional Trader A', target: 5, progress: 0 },
        { achievementName: 'Monopolist B', target: 6, progress: 0 },
        { achievementName: 'Specialist A', target: 3, progress: 0 },
      ],
      position: { column: 8, row: 5 },
      victoryPoints: 47,
      cargo: ['black', 'blue', 'yellow', 'black', 'black'],
